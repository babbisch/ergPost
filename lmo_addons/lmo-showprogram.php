...
?>
        <tr>
          <th align="right">&nbsp;<a href="<? echo $addr.($j+1); ?>" title="<? echo $text[25]; ?>"><? 
			...
			if (is_array($spieltagsname) AND is_array($spieltagsname[$j+1])){//DH SPIELTAGSNAME
					echo $spieltagsname[$j+1][1];
				  }//DH SPIELTAGSNAME
			else {//DH SPIELTAGSNAME
					echo $j+1;
			}//DH SPIELTAGSNAME
