...
define('_berichtescript_','".$urlshort."index.php?site=berichte&');
define('_ergpostscript_','".$urlshort."index.php?site=ergpost');
define('_lmophp_','".$urlshort."lmo/lmo.php?');
define('_userlogin_','".$urlshort."login.php');
define('_userlogout_','".$urlshort."setuser.php');
define('_userid_',"."$"."userID);
define('_username_',getnickname("."$"."userID));
?>";
