...
if(isset($_POST['sendliga'])) {
   ...
   echo $error;
   if($error == '') {
      $ligen = fopen("include/contents/ergpost/ligen.ini","ab");
      ...
      fclose($ligen);
      $liga = fopen("include/contents/ergpost/ligen/".$_POST['ligafilename'], "ab");
      fclose($liga);
   }
   //header("Location: admin.php?ergpostadmin");
} else {
   $ligen = fopen("include/contents/ergpost/ligen.ini","rb");
   ...
   echo "<form name='ligenadmin' method='post' action='admin.php?ergpostadmin'>
