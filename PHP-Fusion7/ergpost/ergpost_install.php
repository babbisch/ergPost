...
define('_berichtescript_','".$urlshort."berichte.php?');
define('_ergpostscript_','".$urlshort."ergpost.php');
define('_lmophp_','".$urlshort."lmo/lmo.php?');
define('_userlogin_','".$urlshort."login.php');
define('_userlogout_','".$urlshort."setuser.php?logout=yes');
define('_userid_',"."$"."userdata['user_id']);
define('_username_',"."$"."userdata['user_name']);
?>";
