...
opentable("Administration der Ligeneinstellung");
$error='';
...
if(isset($_POST['sendliga'])) {
   ...
   if($error == '') {
      ...
      fclose($liga);
      echo "Liga gerspeichert.<a href='".FUSION_SELF."'>zurück</a>";;
   }
} else {
   ...
   echo "<form name='ligenadmin' method='post' action='".FUSION_SELF."'>
