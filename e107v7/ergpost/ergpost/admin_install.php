...
?>
  ...
  if ($error == '') {
    ...
    $config = "<?php\r
define('_ergposthilfe_','http://www.derhasi.de/drupal/ergpost');\r
define('_berichtescript_','".$urlshort."berichte.php?');\r
define('_ergpostscript_','".$urlshort."ergpost.php');\r
define('_lmophp_','http://".$_SERVER['HTTP_HOST']."/e107_plugins/lmo/lmo.php?');\r
define('_userlogin_','http://".$_SERVER['HTTP_HOST']."/login.php');\r
define('_userlogout_','http://".$_SERVER['HTTP_HOST']."/index.php?logout');\r
define('_userid_',USERID);\r
define('_username_',USERNAME);\r
?>";
